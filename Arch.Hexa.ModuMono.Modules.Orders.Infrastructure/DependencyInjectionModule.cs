...
using Arch.Hexa.ModuMono.Modules.Orders.Infrastructure.Persistence.Repositories;
using Arch.Hexa.ModuMono.Modules.Orders.Infrastructure.Sql.Interceptors;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Logging;

namespace Arch.Hexa.ModuMono.Modules.Orders.Infrastructure
{
    public static class DependencyInjectionModule
    {
        public static IServiceCollection AddOrdersInfrastructure(this IServiceCollection services, string databaseConnectionString)
        {
            // SQL Interceptors
            services.AddSingleton<OrderWriteSqlInterceptor>();
            services.AddSingleton<OrderReadSqlInterceptor>();
            ...
            services.AddDbContext<OrderDbContext>((sp, options) =>
                {
                    ...
                    options.AddInterceptors(sp.GetRequiredService<OrderWriteSqlInterceptor>());
                },
            ...
            services.AddPooledDbContextFactory<OrderDbContext>((sp, options) =>
            {
                ...
                options.UseLoggerFactory(sp.GetRequiredService<ILoggerFactory>());
                options.AddInterceptors(sp.GetRequiredService<OrderReadSqlInterceptor>());
            });
            ...
            services.AddScoped(typeof(IOrderLineReadRepository<,>), typeof(OrderLineReadRepository<,>));
